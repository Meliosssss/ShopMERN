            ...
            <div className='max-padd-container flex w-full flex-col gap-14'>
                <div className='flex flex-col items-start justify-center gap-[10%] md:flex-row'>
                    <div className='max-w-72'>
                        <Link to={'/'} className='mb-10 bold-20'><span className='bold-28 text-secondary'>S</span>hopShoe</Link>
                        <div className='mb-8'>
                ...
                <p className='text-center regular-14 text-gray-30'>2024 SHOPSHOES</p>
            </div>
        </footer>
    )
}
