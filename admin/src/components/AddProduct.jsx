    ...
    return (
        <div className='p-8 box-border bg-white w-full rounded-sm mt-4 lg:m-7'>
            <div className='mb-3'>
                ...
                <input value={productDetails.name} onChange={changeHandler} type='text' name='name' placeholder='Type here...' className='bg-primary outline-none max-w-80 w-full py-2 px-4 rounded-md' />
            </div>
            <div className='mb-3'>
                <h4 className='bold-18 pb-2'>Price:</h4>
                <input value={productDetails.old_price} onChange={changeHandler} type='text' name='old_price' placeholder='Type here...' className='bg-primary outline-none max-w-80 w-full py-2 px-4 rounded-md' />
            </div>
            <div className='mb-3'>
                <h4 className='bold-18 pb-2'>Offer Price:</h4>
                <input value={productDetails.new_price} onChange={changeHandler} type='text' name='new_price' placeholder='Type here...' className='bg-primary outline-none max-w-80 w-full py-2 px-4 rounded-md' />
            </div>
            ...
            <button onClick={() => Add_Product()} className='btn-dark mt-4 flexCenter gap-x-1 rounded-md'><MdAdd />Add Product</button>
        </div>
    )
}
